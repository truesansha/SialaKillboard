...
namespace Siala.Domain.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InvolvedPlayers",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AttackerClass1Id = table.Column<int>(nullable: false),
                    AttackerClass1Level = table.Column<int>(nullable: false),
                    AttackerClass2Id = table.Column<int>(nullable: true),
                    AttackerClass2Level = table.Column<int>(nullable: true),
                    AttackerClass3Id = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvolvedPlayers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VictimClass1Level = table.Column<int>(nullable: false),
                    VictimClass2Id = table.Column<int>(nullable: true),
                    VictimClass2Level = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Class1Id = table.Column<int>(nullable: false),
                    Class1Level = table.Column<int>(nullable: false),
                    Class2Id = table.Column<int>(nullable: true),
                    Class2Level = table.Column<int>(nullable: true),
                    Class3Id = table.Column<int>(nullable: true),
                    Class3Level = table.Column<int>(nullable: true),
